...
struct ext2_inode {
	...
	double	i_latitude; /* GPS Latitude (double - 64 bits) */
	double	i_longitude; /* GPS Longitude (double - 64 bits) */
	int 	i_accuracy; /* GPS accuracy in meters (int - 32 bits) */
	/* At the moment when an inode is create/update, store the age
	 * of the gps information (we get from the kernel) here. */
	int	i_coord_age; /* int - 32 bits */
};
